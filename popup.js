...
function getFileUrl(searchTerm, callback, errorCallback) {
...
function display_a(results) {
	console.log(results);
	h1 = results;
	document.querySelector("#result").innerHTML = "<p>tab title: " + tab_title + "</p><p>dom h1: " + h1 + "</p>";
}
...
function display_h1(results) {
	...
	//   str += results[i].outerHTML;
	// }
	document.querySelector("#result").innerHTML = results;
}
// res = "";for(var i =0;i<document.querySelectorAll("a");i++){res +=document.querySelectorAll("a")[i].outerHTML;}return res;


console.log($);
$(function () {
	$("input").on("click", function () {
		var $chk = $("#filter input[name = 'docType']");
		console.log($chk)
	})
})
